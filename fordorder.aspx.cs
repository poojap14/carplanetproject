...
namespace carplanet
{
    public partial class fordorder : System.Web.UI.Page
    {
        ...
        private void InsertOrderDetail(string uname, int pq1, int pq2, int pq3, int pq4, string total)
        {
            try
            {
                ...
                string insertQuery = "INSERT INTO orderford(username,ecosport,endeavour,figo,fiesta,total) VALUES (@username,@ecosport,@endeavour,@figo,@fiesta,@total)";

                using (SqlCommand cmd = new SqlCommand(insertQuery, conn))
                {
                    cmd.Parameters.AddWithValue("@username", uname);
                    cmd.Parameters.AddWithValue("@ecosport", pq1);
                    cmd.Parameters.AddWithValue("@endeavour", pq2);
                    cmd.Parameters.AddWithValue("@figo", pq3);
                    cmd.Parameters.AddWithValue("@fiesta", pq4);
