...
namespace carplanet
{
    public partial class hyundai : System.Web.UI.Page
    {
        ...
        protected void ordernow(object sender, EventArgs e)
        {
            ...
            string p1 = "Hyundai Creta";
            string p2 = "Hyundai Venue";
            string p3 = "Hyundai Verna";
            string p4 = "Hyundai Aura";
            ...
            decimal[] productPrices = { 1100000, 800000,1050000, 6500000 };
            ...
            Response.Redirect($"hyundaiorder.aspx?OverallSubtotal={overallSubtotal}&TaxAmount={taxAmount}&ShippingCost={shippingCost}&Total={total}&p1={p1}&pq1={pq1}&p2={p2}&pq2={pq2}&p3={p3}&pq3={pq3}&p4={p4}&pq4={pq4}");
