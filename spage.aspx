<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="spage.aspx.cs" Inherits="carplanet.spage" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <h2 style="color:antiquewhite" align="center">SERVICEMEN REGISTRATION</h2>
...
<h3 style="width: 453px; margin-left: 19px;color:azure" textalign="center" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Enter Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
    ...
    <asp:TextBox ID="conf" runat="server" style="margin-left: 24px" Width="199px"></asp:TextBox>
                    ...
                    <br />
                    <br />   <br />
                        <asp:HyperLink ID="HyperLink1" runat="server"  Font-Names="Arial Black" ForeColor="Lime" NavigateUrl="~/slogin.aspx">Already have an account?</asp:HyperLink>
                   </div>
