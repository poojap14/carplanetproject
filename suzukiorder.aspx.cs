...
namespace carplanet
{
    public partial class suzukiorder : System.Web.UI.Page
    {
        ...
        private void InsertOrderDetail(string uname, int pq1, int pq2, int pq3, int pq4, string total)
        {
            try
            {
                ...
                string insertQuery = "INSERT INTO suzuki(username,fronx,grandvitara,brezza,ertiga,total) VALUES (@username,@fronx,@grandvitara,@brezza,@ertiga,@total )";

                using (SqlCommand cmd = new SqlCommand(insertQuery, conn))
                {
                    cmd.Parameters.AddWithValue("@username", uname);
                    cmd.Parameters.AddWithValue("@fronx", pq1);
                    cmd.Parameters.AddWithValue("@grandvitara", pq2);
                    cmd.Parameters.AddWithValue("@brezza", pq3);
                    cmd.Parameters.AddWithValue("@ertiga", pq4);
