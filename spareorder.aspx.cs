...
namespace carplanet
    {
        public partial class spareorder : System.Web.UI.Page
        {
            ...
            private void InsertOrderDetail(string uname, int pq1, int pq2, int pq3, int pq4, string total)
            {
                try
                {
                    ...
                    string insertQuery = "INSERT INTO spareparts(username,carbattery, rearviewmirror,brakelight,bumper,total) VALUES (@username,@carbattery,@rearviewmirror,@brakelight,@bumper,@total )";

                    using (SqlCommand cmd = new SqlCommand(insertQuery, conn))
                    {
                        cmd.Parameters.AddWithValue("@username", uname);
                        cmd.Parameters.AddWithValue("@carbattery", pq1);
                        cmd.Parameters.AddWithValue("@rearviewmirror", pq2);
                        cmd.Parameters.AddWithValue("@brakelight", pq3);
                        cmd.Parameters.AddWithValue("@bumper", pq4);
