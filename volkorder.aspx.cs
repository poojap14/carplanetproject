...
namespace carplanet
{
    public partial class volkorder : System.Web.UI.Page
    {
        ...
        private void InsertOrderDetail(string uname, int pq1, int pq2, int pq3, int pq4, string total)
        {
            try
            {
                ...
                string insertQuery = "INSERT INTO ordervolk(username,virtus,taigun,polo,vento,total) VALUES (@username,@virtus,@taigun,@polo,@vento,@total )";

                using (SqlCommand cmd = new SqlCommand(insertQuery, conn))
                {
                    cmd.Parameters.AddWithValue("@username", uname);
                    cmd.Parameters.AddWithValue("@virtus", pq1);
                    cmd.Parameters.AddWithValue("@taigun", pq2);
                    cmd.Parameters.AddWithValue("@polo", pq3);
                    cmd.Parameters.AddWithValue("@vento", pq4);
