...
namespace carplanet
{
    public partial class tata : System.Web.UI.Page
    {
        ...
        protected void ordernow(object sender, EventArgs e)
        {
            ...
            string p1 = "Tata Nexon";
            string p2 = "Tata Punch";
            string p3 = "Tata safari";
            string p4 = "Tata Altroz";
            ...
            decimal[] productPrices = { 815000, 615000, 1600000, 665000 };
            ...
            Response.Redirect($"tataorder.aspx?OverallSubtotal={overallSubtotal}&TaxAmount={taxAmount}&ShippingCost={shippingCost}&Total={total}&p1={p1}&pq1={pq1}&p2={p2}&pq2={pq2}&p3={p3}&pq3={pq3}&p4={p4}&pq4={pq4}");
