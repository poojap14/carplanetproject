...
namespace carplanet
{
    public partial class mahindra : System.Web.UI.Page
    {
        ...
        protected void ordernow(object sender, EventArgs e)
        {
            ...
            string p1 = "Mahindra Thar";
            string p2 = "Mahindra Scorpio";
            string p3 = "Mahindra XUV700";
            string p4 = "Mahindra Bolero";
            ...
            decimal[] productPrices = { 1300000, 1400000, 1500000, 1000000 };
            ...
            Response.Redirect($"mahindraorder.aspx?OverallSubtotal={overallSubtotal}&TaxAmount={taxAmount}&ShippingCost={shippingCost}&Total={total}&p1={p1}&pq1={pq1}&p2={p2}&pq2={pq2}&p3={p3}&pq3={pq3}&p4={p4}&pq4={pq4}");
