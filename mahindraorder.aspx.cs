...
namespace carplanet
{
    public partial class mahindraorder : System.Web.UI.Page
    {
        ...
        private void InsertOrderDetail(string uname, int pq1, int pq2, int pq3, int pq4, string total)
        {
            try
            {
                ...
                string insertQuery = "INSERT INTO ordermahindra(username,thar,scorpio,xuv,bolero,total) VALUES (@username,@thar,@scorpio,@xuv,@bolero,@total )";

                using (SqlCommand cmd = new SqlCommand(insertQuery, conn))
                {
                    cmd.Parameters.AddWithValue("@username", uname);
                    cmd.Parameters.AddWithValue("@thar", pq1);
                    cmd.Parameters.AddWithValue("@scorpio", pq2);
                    cmd.Parameters.AddWithValue("@xuv", pq3);
                    cmd.Parameters.AddWithValue("@bolero", pq4);
