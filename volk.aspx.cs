...
namespace carplanet
{
    public partial class volk : System.Web.UI.Page
    {
        ...
        protected void ordernow(object sender, EventArgs e)
        {
            ...
            string p1 = "Volkswagen Virtus";
            string p2 = "Volkswagen Taigun";
            string p3 = "Volkswagen Polo";
            string p4 = "Volkswagen Vento ";
            ...
            decimal[] productPrices = { 1160000, 1180000, 700000, 1300000 };
            ...
            Response.Redirect($"volkorder.aspx?OverallSubtotal={overallSubtotal}&TaxAmount={taxAmount}&ShippingCost={shippingCost}&Total={total}&p1={p1}&pq1={pq1}&p2={p2}&pq2={pq2}&p3={p3}&pq3={pq3}&p4={p4}&pq4={pq4}");
