...
namespace carplanet
{
    public partial class renault : System.Web.UI.Page
    {
        ...
        protected void ordernow(object sender, EventArgs e)
        {
            ...
            string p1 = "Renault Kwid";
            string p2 = "Renault Triber";
            string p3 = "Renault Kiger";
            string p4 = "Renault Duster";
            ...
            decimal[] productPrices = { 480000, 600000, 700000, 1000000 };
            ...
            Response.Redirect($"renaultorder.aspx?OverallSubtotal={overallSubtotal}&TaxAmount={taxAmount}&ShippingCost={shippingCost}&Total={total}&p1={p1}&pq1={pq1}&p2={p2}&pq2={pq2}&p3={p3}&pq3={pq3}&p4={p4}&pq4={pq4}");
