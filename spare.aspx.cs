...
namespace carplanet
{
    public partial class spare : System.Web.UI.Page
    {
        ...
        protected void ordernow(object sender, EventArgs e)
        {
            ...
            string p1 = "Car Battery";
            string p2 = "Rear View mirror";
            string p3 = "BrakeLights";
            string p4 = "Bumper";
            ...
            decimal[] productPrices = { 4800, 700, 600, 1700 };
            ...
            decimal[] productSubtotals = new decimal[4];
            ...
            decimal shippingCost = 100;
            decimal total = overallSubtotal + taxAmount + shippingCost;

           
            Response.Redirect($"spareorder.aspx?OverallSubtotal={overallSubtotal}&TaxAmount={taxAmount}&ShippingCost={shippingCost}&Total={total}&p1={p1}&pq1={pq1}&p2={p2}&pq2={pq2}&p3={p3}&pq3={pq3}&p4={p4}&pq4={pq4}");
