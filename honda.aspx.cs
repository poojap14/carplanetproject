...
namespace carplanet
{
    public partial class honda : System.Web.UI.Page
    {
        ...
        protected void ordernow(object sender, EventArgs e)
        {
            ...
            string p1 = "Honda Elevate";
            string p2 = "Honda Amaze";
            string p3 = "Honda WR-V ";
            string p4 = "Honda City ";
            ...
            decimal[] productPrices = { 1400000, 760000, 912000, 1200000 };
            ...
            Response.Redirect($"hondaorder.aspx?OverallSubtotal={overallSubtotal}&TaxAmount={taxAmount}&ShippingCost={shippingCost}&Total={total}&p1={p1}&pq1={pq1}&p2={p2}&pq2={pq2}&p3={p3}&pq3={pq3}&p4={p4}&pq4={pq4}");
