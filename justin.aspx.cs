...
namespace carplanet
{
    public partial class justin : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            void DisplayOrderDetails()
            {
                ...
                string query = "SELECT appointmentid,FromAddress, date, body FROM appointmentbooking WHERE ToAddress ='peekapeekaboo.53@gmail.com' ";
