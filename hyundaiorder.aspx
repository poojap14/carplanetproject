<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hyundaiorder.aspx.cs" Inherits="carplanet.hyundaiorder" %>
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="user" ErrorMessage="RequiredFieldValidator" ForeColor="#FF6600">*required</asp:RequiredFieldValidator>
         ...
         <p>&nbsp;</p>
         <p>&nbsp;</p>
     		   <asp:Button ID="Button1" runat="server" style="border-radius:50px;align-content:center;margin-right:200px;margin-left:406px;transform: scale(1.01);" Text="Proceed to Pay" BackColor="dimgray"
                     Font-Names="Bahnschrift SemiBold" Font-Size="X-Large" ForeColor="White" Height="55px" Width="208px" OnClientClick="alert_meth()" OnClick="Button1_click"/>
             </form>
